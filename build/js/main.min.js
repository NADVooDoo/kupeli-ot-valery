...
var _initEmail = require("./vendor/init-email");
var _initGallerySwiper = require("./modules/init-gallery-swiper");
var _initBenefitsSwiper = require("./modules/init-benefits-swiper");
var _initContactsMap = require("./modules/init-contacts-map");
var _initDocumentsSwiper = require("./modules/init-documents-swiper");
var _fancybox = require("./vendor/fancybox");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _initGallerySwiper.getGallerySlider)();
    (0, _initEmail.initEmailJS)();
    ...
    select.init();
    (0, _initBenefitsSwiper.getBenefitsSlider)();
    (0, _initBenefitsSwiper.initSlider)();
    (0, _initDocumentsSwiper.getDocumentsSlider)();
    (0, _initContactsMap.getMap)();
    _fancybox.Fancybox.bind("[data-fancybox]", {});
  });
});
...
var Burger = exports.Burger = /*#__PURE__*/function () {
  ...
  _createClass(Burger, [{
    ...
    value: function _onDocumentClick(evt) {
      if (this._isMenuOpen) {
        var closeMenuButton = evt.target.closest('[data-close-menu]');
        var linkMenuButton = evt.target.closest('[data-link-menu]');
...
},{"../../utils/focus-lock":16,"../../utils/scroll-lock":20}],3:[function(require,module,exports){
"use strict";
...
var _emailMin = require("../../vendor/email-min");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var Form = exports.Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function _onFormSubmit(event) {
      ...
      var existingHiddenInput = event.target.querySelector('input[type="hidden"][name="led"]');
      if (existingHiddenInput) {
        event.target.removeChild(existingHiddenInput);
      }
      // Изменяем значение чекбокса перед отправкой
      var ledCheckbox = event.target.querySelector('input[name="led"]');
      ...
      if (this.validateForm(event.target)) {
        ...
        _emailMin.emailjs.sendForm('service_2hoknrq', 'template_qnmamf8', event.target).then(function (response) {
          ...
          if (callback) {
            _this3._callbacks[callback].successCallback(event);
          }
          // Логика перестроения модального окна
          if (_this3._callbacks[callback].reset) {
            setTimeout(function () {
              _this3.reset(event.target);
              var modal = event.target.closest('.modal');
              if (modal) {
                // Скрыть все элементы формы, заголовок и текст
                var formElements = modal.querySelectorAll('.modal__form [data-validate-type], .modal__title, .modal__text, .modal__button, .custom-toggle--led');
                formElements.forEach(function (element) {
                  return element.style.display = 'none';
                });

                // Показать сообщение об успешной отправке
                var successMessage = modal.querySelector('.modal__success');
                successMessage.style.display = 'block';
              }
            }, _this3._callbacks[callback].resetTimeout ? _this3._callbacks[callback].resetTimeout : 500);
          }
        }, function (error) {
          console.log('Заявка застряла в интернете...', error);
          // Вызов callback функции ошибки, если форма не валидна и callback определен
          if (callback) {
            _this3._callbacks[callback].errorCallback(event);
          }
        }).finally(function () {
          setTimeout(function () {
...
document.querySelectorAll('.custom-select__item').forEach(function (item) {
...
},{"../../vendor/email-min":21,"./callback":3,"./init-phone-input":5,"./validator":9}],5:[function(require,module,exports){
"use strict";
...
exports.initSlider = exports.getBenefitsSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
var _isMobileDevice = require("../utils/is-mobile-device");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var swiper = null;
var resizeTimeout = null;
var getBenefitsSlider = exports.getBenefitsSlider = function getBenefitsSlider() {
  if (document.querySelector('[data-benefits-slider]')) {
    ...
    swiper = new _swiper.default('[data-benefits-slider]', {
...
var initSlider = exports.initSlider = function initSlider() {
...
},{"../utils/is-mobile-device":19,"../vendor/swiper":28}],11:[function(require,module,exports){
"use strict";
...
var getMap = exports.getMap = function getMap() {
  ...
  var coordinate = [54.683517, 39.603954];
  ...
  (0, _leaflet.tileLayer)(tileUrl).addTo(map);
  (0, _leaflet.marker)(coordinate, {
    icon: icon
  }).bindPopup(markerText).addTo(map);
};

},{"../vendor/leaflet":24}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getDocumentsSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
var _isMobileDevice = require("../utils/is-mobile-device");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var getDocumentsSlider = exports.getDocumentsSlider = function getDocumentsSlider() {
  if (document.querySelector('[data-documents-slider]')) {
    return new _swiper.default('[data-documents-slider]', {
      allowTouchMove: (0, _isMobileDevice.isMobileDevice)(),
      slidesPerView: 'auto',
      navigation: {
...
},{"../utils/is-mobile-device":19,"../vendor/swiper":28}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getGallerySlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
var _isMobileDevice = require("../utils/is-mobile-device");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var getGallerySlider = exports.getGallerySlider = function getGallerySlider() {
  if (document.querySelector('[data-gallery-slider]')) {
    return new _swiper.default('[data-gallery-slider]', {
      allowTouchMove: (0, _isMobileDevice.isMobileDevice)(),
      slidesPerView: 'auto',
      navigation: {
...
},{"../utils/is-mobile-device":19,"../vendor/swiper":28}],14:[function(require,module,exports){
"use strict";
    ...
    value: function open() {
      ...
      setTimeout(function () {
        ...
        if (_this._lockFocus) {
          ...
          var inputWithFocus = modal.querySelector('[data-focus]');
          if (inputWithFocus) {
            setTimeout(function () {
...
var mobileKeywords = ['iPhone', 'iPad', 'iPod', 'Android', 'webOS', 'BlackBerry', 'Windows Phone', 'Opera Mini', 'IEMobile', 'Mobile', 'Tablet'];
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var emailjs = exports.emailjs = function (e) {
  "use strict";

  var t = /*#__PURE__*/_createClass(function t() {
    _classCallCheck(this, t);
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
      _t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "Network Error";
    this.status = e, this.text = _t;
  });
  var i = {
      ...
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e, r) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              o = _args.length > 2 && void 0 !== _args[2] ? _args[2] : {};
              _context.next = 3;
              return fetch(i.origin + e, {
                method: "POST",
                headers: o,
                body: r
              });
    ...
    n = function n(e) {
      return e.webdriver || !e.languages || 0 === e.languages.length;
    },
    l = function l() {
      return new t(451, "Unavailable For Headless Browser");
    },
    c = function c(e, t) {
      if (function (e) {
        var t;
      ...
      var i = (r = t, o = e.watchVariable, r instanceof FormData ? r.get(o) : r[o]);
      var r, o;
      return "string" == typeof i && e.list.includes(i);
    },
    d = function d() {
      return new t(403, "Forbidden");
    },
    m = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e, t, i) {
        var r, o;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.next = 6;
              return function () {
                var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e, t, i) {
                  var r;
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                      ...
                      case 6:
                        ...
                        r = (0, _context2.t0)(_context2.t2);
                        return _context2.abrupt("return", t - Date.now() + r);
                      case 9:
                      case "end":
            ...
            case 6:
              ...
              _context3.next = 11;
              return i.set(r, Date.now().toString());
            case 11:
              _context3.t0 = !1;
            case 12:
      ...
      return function m(_x3, _x4, _x5) {
        return _ref2.apply(this, arguments);
      };
    }(),
    h = function h() {
      return new t(429, "Too Many Requests");
    },
    p = /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e, t, o, _p) {
        var u, b, g, f, v, w, y;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              u = r(_p), b = u.publicKey || i.publicKey, g = u.blockHeadless || i.blockHeadless, f = i.storageProvider || u.storageProvider, v = _objectSpread(_objectSpread({}, i.blockList), u.blockList), w = _objectSpread(_objectSpread({}, i.limitRate), u.limitRate);
              if (!(g && n(navigator))) {
                _context4.next = 3;
                break;
              }
              return _context4.abrupt("return", Promise.reject(l()));
            case 3:
              if (!(s(b, e, t), function (e) {
                if (e && "[object Object]" !== e.toString()) throw "The template params have to be the object. Visit https://www.emailjs.com/docs/sdk/send/";
              }(o), o && c(v, o))) {
                _context4.next = 5;
                break;
              }
              return _context4.abrupt("return", Promise.reject(d()));
            case 5:
              _context4.next = 7;
              return m(location.pathname, w, f);
            case 7:
              if (!_context4.sent) {
                _context4.next = 9;
                break;
              }
              return _context4.abrupt("return", Promise.reject(h()));
            case 9:
              y = {
                lib_version: "4.3.3",
                user_id: b,
              ...
              return _context4.abrupt("return", a("/api/v1.0/email/send", JSON.stringify(y), {
      ...
      return function p(_x9, _x10, _x11, _x12) {
        return _ref4.apply(this, arguments);
      };
    }(),
    u = /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(e, t, o, p) {
        var u, b, g, f, v, w, y, j;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              u = r(p), b = u.publicKey || i.publicKey, g = u.blockHeadless || i.blockHeadless, f = i.storageProvider || u.storageProvider, v = _objectSpread(_objectSpread({}, i.blockList), u.blockList), w = _objectSpread(_objectSpread({}, i.limitRate), u.limitRate);
              if (!(g && n(navigator))) {
                _context5.next = 3;
                break;
              }
              return _context5.abrupt("return", Promise.reject(l()));
            case 3:
              y = function (e) {
            ...
            case 12:
              ...
              _context5.t1 = Promise.reject(h());
              _context5.next = 17;
              break;
            case 16:
              _context5.t1 = (j.append("lib_version", "4.3.3"), j.append("service_id", e), j.append("template_id", t), j.append("user_id", b), a("/api/v1.0/email/send-form", j));
            case 17:
      ...
      return function u(_x13, _x14, _x15, _x16) {
  ...
  return e.EmailJSResponseStatus = t, e.default = b, e.init = o, e.send = p, e.sendForm = u, Object.defineProperty(e, "__esModule", {
    value: !0
  }), e;
}({});
  ...
  var te = /*#__PURE__*/function (_$10) {
    ...
    _createClass(te, [{
      ...
      value: function createEl(t) {
        ...
        if (l) for (var _i70 = 0, _Object$entries7 = Object.entries(Kt); _i70 < _Object$entries7.length; _i70++) {
        ...
        s.on("*", function (t, e) {
          ...
          if (s) {
            var _t66 = Math.abs(e.current.f),
              _i71 = _t66 < 1 ? "" : Math.max(.5, Math.min(1, 1 - _t66 / e.contentRect.fitHeight * 1.5));
          ...
          if (!t.isInfinite) {
            ...
            try {
              for (_iterator40.s(); !(_step40 = _iterator40.n()).done;) {
                ...
                t.page < t.pages.length - 1 ? (_i72.removeAttribute(pe), _i72.removeAttribute(fe)) : (_i72.setAttribute(pe, ""), _i72.setAttribute(fe, "-1"));
              }
            } catch (err) {
              _iterator40.e(err);
            } finally {
            ...
            try {
              for (_iterator41.s(); !(_step41 = _iterator41.n()).done;) {
                var _i73 = _step41.value;
                t.page > 0 ? (_i73.removeAttribute(pe), _i73.removeAttribute(fe)) : (_i73.setAttribute(pe, ""), _i73.setAttribute(fe, "-1"));
              }
            } catch (err) {
              _iterator41.e(err);
            } finally {
      ...
      value: function focus(t) {
        ...
        for (var _i76 = 0, _l5 = l; _i76 < _l5.length; _i76++) {
          ...
          var _e65 = !_t71.offsetParent || !!_t71.closest('[aria-hidden="true"]'),
            _i77 = r && r.contains(_t71),
            _n24 = !o.contains(_t71);
          if (_t71 === s || (_i77 || _n24) && !_e65) {
            c.push(_t71);
      ...
      value: function showLoading(t) {
        ...
        C(e, he), this.emit("loading", t), t.spinnerEl || setTimeout(function () {
          if (!_this44.isClosing() && !t.spinnerEl && t.state === ct.Loading) {
            var _i78 = s(E);
            C(_i78, "fancybox-spinner"), t.spinnerEl = _i78, e.prepend(_i78), _this44.animate(_i78, "f-fadeIn");
          }
        }, 250);
      }
    }, {
        ...
        if (r && (et(r) ? ot(r) : r.focus()), s && (P(s, de), C(s, "is-closing"), s.setAttribute(ae, "true"), this.option("animated") && C(s, le), s.style.pointerEvents = "none"), o) {
          ...
          try {
            for (_iterator44.s(); !(_step44 = _iterator44.n()).done;) {
              ...
              _e68 && this.stop(_e68);
              var _i79 = null == _t74 ? void 0 : _t74.panzoom;
              _i79 && (_i79.stop(), _i79.detachEvents(), _i79.detachObserver()), this.isCurrentSlide(_t74) || o.emit("removeSlide", _t74);
            }
          } catch (err) {
            _iterator44.e(err);
          } finally {
        ...
        try {
          for (_iterator46.s(); !(_step46 = _iterator46.n()).done;) {
            ...
            var _t77 = _n26.dataset || {},
              _s17 = _t77[ve] || _n26.getAttribute(me) || _n26.getAttribute("currentSrc") || _n26.getAttribute(ve) || void 0;
            var _o14 = void 0;
            var _a11 = e.delegate;
            var _r4 = void 0;
...
exports.initEmailJS = void 0;
var _emailMin = require("./email-min");
var initEmailJS = exports.initEmailJS = function initEmailJS() {
  _emailMin.emailjs.init({
    publicKey: 'iYEZTsn65E9xeZ_41'
  });
};

},{"./email-min":21}],24:[function(require,module,exports){
"use strict";
...
var createNativeSelectMarkup = exports.createNativeSelectMarkup = function createNativeSelectMarkup(_ref) {
  var id = _ref.id,
    items = _ref.items,
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var CustomSelect = exports.CustomSelect = /*#__PURE__*/function () {
...
},{"./create-select-markup":25,"./utils":27}],27:[function(require,module,exports){
"use strict";
...
var createElement = exports.createElement = function createElement(template) {
  var newElement = document.createElement('div');
  newElement.innerHTML = template;
  return newElement.firstChild;
};
var renderElement = exports.renderElement = function renderElement(container, component) {
