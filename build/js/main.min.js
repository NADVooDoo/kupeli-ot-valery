...
},{"./modules/burger/burger":2,"./modules/form-validate/form":4,"./modules/modals/init-modals":10,"./utils/ios-vh-fix":14,"./vendor/init-email":16,"./vendor/select/custom-select":18}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":12,"../../utils/scroll-lock":15}],3:[function(require,module,exports){
"use strict";
  ...
  _createClass(Form, [{
    ...
    value: function _onFormSubmit(event) {
      ...
      if (this.validateForm(event.target)) {
        ...
        emailjs.sendForm('service_2hoknrq', 'template_qnmamf8', event.target).then(function (response) {
